    ...
    const random = (min, max) => Math.round(Math.random() * (max - min) + min);
        ...
        inputs.forEach(input => {
            const mapping = {
                ...
                'buyer.person.passport.birthPlace': () => 'место рождения',
                'buyer.person.passport.registrationAddress': () => 'город Москва Есенинский бульвар дом 9',
                ...
                'acquisitionContract.number': () => "Тестовый",
